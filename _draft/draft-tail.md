...
色付きジョーンズ多項式の **tail** (ここでは尻尾と訳しました) は [Dasbach-Lin]() においてその存在が予想され, [Armond, 2013]() と [Garoufalidis-Le]() によって独立に証明された色付きジョーンズ多項式のある種の極限です. この極限は $q$ を変数とする $\mathbb{Z}$ 係数の形式的べき級数として与えられます.
